...
const getXurItems_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'getXurItems' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
...
const LaunchRequest_Handler =  {
    ...
    handle(handlerInput) {
        ...
        let say = 'hello gaurdian...' + ' and welcome to ' + invocationName + ' ! Ask me what Xur has for sale.';
...
const model = {
  "interactionModel": {
    "languageModel": {
      "invocationName": "the destiny two speaker",
      "intents": [
        {
